...
class WC_Serveloja_Gateway extends WC_Payment_Gateway
{
    ...
    private function wcsvl_modal()
    {
            ...
            "<div class=\'modalCancelar\'>" +
                        "<div class=\'modalCancelarConteudo\'>" +
                            ...
                            "<div class=\'modalCancelarBotoes\'>"+
                                ...
                                //"<button id=\'modalCancelarBotaoSim\' name=\'cancelarSim\' value=\'Sim\'>Sim</button>" 
                                "<span style=\'font-size: 0.7rem;color:#000;\'> sim </span>"
                                 +
                                "</a>" +
        ...
        function wcsvl_modalCancelar(url) {
            ...
            $("#modalCancelarBotaoNao").click( function () {
                    ...
                    "<div class=\'modalSucesso\'>" +
                        "<div class=\'modalSucessoConteudo\'>" +
                            ...
                            "<div class=\'modalSucessoInfo\'>"+
                                ...
                                "<p style=\'margin-bottom: 0px !important;\' class=\'rodapeModalSucesso\'></p>"+
                                "<button type=\'button\'  style=\'color:#fff;background-color: #24B24B;padding:15px!important;\'  id=\'btnWpp\' class=\'descricaoModalSucessoInfo\'> <i class=\'fab fa-whatsapp fa-lg\'></i> Enviar pedido no whatsapp </button>"+
        ...
        function wcsvl_modalSucesso(url, bg, nome, valorTotal, bandeira, numeroCarao, parcela, codigoCompra , produtos , quantidadeProdutos , whatsapp , endereco ) {
            ...
            var nome = nome;
            var produtos = produtos.join("");
            //var quantidadeProdutos = quantidadeProdutos;
            ...
            setTimeout(function () {
                ...
                $("#btnWpp").click(() => {
                    ...
                    mensagem += "*PEDIDOS ENVIADO*%0a";
                    mensagem +=  "------------------------------------%0a";
                    mensagem += "*RESUMO DO PEDIDO*%0a%0a";
                    mensagem += "*Cód:* " + infoCodigo + "%0a%0a";
                    mensagem += "*PRODUTOS*%0a%0a";
                    mensagem +=  produtos;
                    mensagem += "-------------------------------------%0a";
                    mensagem += "*SUBTOTAL* R$" + valorTotal  + "%0a%0a" ;
                    mensagem += "-------------------------------------%0a";
                    mensagem += "*DADOS DO CLIENTE*%0a";
                    mensagem += "*Nome:* " + nome + "%0a" ;
                    mensagem += "*Endereço:* " + endereco.address_1 + " " + endereco.address_2 + "%0a";
                    mensagem += "*Cep:* " + endereco.postcode + "%0a";
                    mensagem += "*Cidade:* " + endereco.city + "%0a";
                    mensagem += "*Whatsapp:* " + endereco.phone + "%0a";

                    //console.log(mensagem);
                    $(location).attr("href","https://api.whatsapp.com/send?phone="+whatsapp+"&text="+mensagem);
                });
                
            }, 300);

            $("#ok, #okConf, #cancela").click(function () {
                alert("Cancelar");
                $("#" + bg).html("");
                $("#" + bg).fadeOut();
                if (url != "") {
    ...
    private function wcsvl_mascarasNovasValidacao(){
        wc_enqueue_js(' 
        ...
        function MascaraCartao(cartao) {
            $(document).ready(function() {
                ...
                str = str.replace(" ","");
                str = str.replace(" ","");
                var regexAmex = /(^3[47]\d{1,4}\-?)(\d{6}\-?)?(\d{5}\-?)/;
                var regexDiners = /^3(?:0[0-5]|[68][0-9])[0-9]{11}/;
                if (mascaraInteiro(cartao) == false) {
                event.returnValue = false;
                }
                if(str.match(regexAmex)){
                    return formataCampo(cartao, "0000-000000-00000");
                }
                if(str.match(regexDiners)){
                    return formataCampo(cartao, "0000-000000-0000");
                }
                else{
                    return formataCampo(cartao, "0000-0000-0000-0000");
                }
            });
          }
          ...
          function ValidaCartao(cartao) {
            var exp = /(^\d{4}\-?\d{4}\-?\d{4}\-?\d{4}$)/;
            var amex = /(^3[47]\d{1,4}\-?)(\d{6}\-?)?(\d{5}?)/;
            var diners = /^3(?:0[0-5]|[68][0-9])[0-9]{11}/;

            if (!exp.test(cartao.value) && !amex.test(cartao.value) && !diners.test(cartao.value.replaceAll("-", ""))) {
                //console.log("erro no cartão" + " " + cartao.value);
                return false;                 
            }else{
                //console.log("validou o cartão" + " " +  cartao.value);
                return true;
            }
          }
          ...
          function MascaraCPF(cpf){
            ...
            if(cpf.value.length <= 14){
              ...
              return formataCampo(cpf, "00.000.000/0000-00");
            }
          }
          ...
          function validarCPF (cpf) {
            ...
            var Resto;
            Soma = 0;
            exp =  /^([0-9]{3}\.?[0-9]{3}\.?[0-9]{3}\-?[0-9]{2}|[0-9]{2}\.?[0-9]{3}\.?[0-9]{3}\/?[0-9]{4}\-?[0-9]{2})$/
            ...
            if (cpf.value.length >= 0) 
            {
                ...
                if (!exp.test(cpf.value)) 
                {
                    ...
                    $("#msgErroCpfCnpjComprador").show();            
                    return false;
                }
                else
                {
                    $("#CpfCnpjComprador").removeClass("hasError");
                    $("#msgErroCpfCnpjComprador").hide();      
                    return true;
                }
            }
            else
    ...
    private function wcsvl_detalhes_cartao($total)
    {
        ...
        wc_enqueue_js('
            $(document).ready(function () {
                ...
                $("#exibeCartao").hide();
                $("input[name=NrCartao]:checked").click(function() {
    ...
    private function wcsvl_compare_data()
    {
        wc_enqueue_js('
            function wcsvl_compareDatas(valCartao) {
                var hoje = new Date(); 
                //var hoje = hoje.getMonth() + "/01/" +  hoje.getFullYear(); 
                //console.log("DataLimite: " + hoje);
                
                var dadosData = valCartao.split("/");
                var validade = new Date(dadosData[0] + "/01/" + dadosData[1]);
                //console.log("DataCartão: " + validade);
    ...
    private function wcsvl_valida_campos()
    {
        wc_enqueue_js('
            $(document).ready(function() {
                ...
                $("#NrCartao, #nmTitular, #DataValidade, #CodSeguranca, #DDDCelular, #NrCelular, #CpfCnpjComprador").mouseleave(function() {
                    
                    if($("#DataValidade").val().length == 7){
                        var validouData = wcsvl_compareDatas($("#DataValidade").val());
                    }

                    if($("#NrCartao").val().length == 19 || $("#NrCartao").val().length == 17 || $("#NrCartao").val().length == 16 ){
                    ...
                    (
                        ...
                        && validarCPF(document.getElementById("CpfCnpjComprador"))
                    ...
                    {
                        //console.log("Aconteceu algum erro na validação");
                        $("#submit-serveloja-payment-form").hide();
                        $("#submit-serveloja-payment-form-false").show();
    ...
    private function wcsvl_form_payment_lightbox($order_id, $https)
    {
        ...
        echo $this->wcsvl_mascarasNovasValidacao();
        ...
        if (($this->wcsvl_apl_authorization() != false) && ($https)) {
                ...
                "<form method=\'POST\' action=\'\' name=\'dados_pagamento\'>" +
                    ...
                    "<div id=\'exibeFormulario\'>" +
                        ...
                        "<div class=\'coluna100\'>" +
                            ...
                            "</span>" +
                            "<div id=\'msgErroCartao\' class=\'erroInputFinalizarCompraLightbox vermelho\'>Cartão inválido.</div>" +
                        "</div>" +
                        ...
                        "<div class=\'coluna100\'>" +
                            ...
                            "<div id=\'msgErroNome\' class=\'erroInputFinalizarCompraLightbox vermelho\'>Nome inválido.</div>" +
                        "</div>" +
                        ...
                        "<div class=\'coluna50_left\'>" +
                            ...
                            "<div id=\'msgErroValidade\' class=\'erroInputFinalizarCompraLightbox vermelho\'>Data inválida.</div>" +
                        "</div>" +
                        ...
                        "<div class=\'coluna50_right\'>" +
                            ...
                            "<div id=\'msgErroCCV\' class=\'erroInputFinalizarCompraLightbox vermelho\'>CCV inválido.</div>" +
                        "</div>" +
                        "<div class=\'clear\'></div>" +
                        ...
                        "<div class=\'coluna25_left\'>" +
                            ...
                            "<div id=\'msgErroDDD\' class=\'erroInputFinalizarCompraLightbox vermelho\'>DDD inválido.</div>" +
                        "</div>" +
                        ...
                        "<div class=\'coluna75\'>" +
                            ...
                            "<div id=\'msgErroCelular\' class=\'erroInputFinalizarCompraLightbox vermelho\'>Número inválido.</div>" +
                        "</div>" +
            ...
            if (!$https) {
                $retorno = '"<div class=\'erro\'>Erro de ativação de protocolo HTTPS.</br></br>O pagamento via Serveloja ainda não está liberado. Entre em contato com o proprietário da loja.</div>"';
            } else {
                $retorno = '"<div class=\'erro\'>Erro de ativação do token da aplicação.</br></br>O pagamento via Serveloja ainda não está liberado. Entre em contato com o proprietário da loja.</div>"';
            }
                    ...
                    <div id=\'exibeFormulario\'>
                        ...
                        <div class=\'coluna100\'>
                            ...
                            <div class=\'colunaDinamica_left\'>
                                <div class=\'tituloInputFinalizarCompraLightbox margin_top\'>Número do cartão</div>
                                    ...
                                    <div id=\'msgErroCartao\' class=\'erroInputFinalizarCompraLightbox vermelho coluna100\'>Cartão inválido.</div>
                            ...
                            <div class=\'colunaDinamica_right\'>
                                ...
                                <div id=\'msgErroNome\' class=\'erroInputFinalizarCompraLightbox vermelho coluna100\'>Nome inválido.</div>
                            </div>
                        ...
                        <div class=\'coluna100\'>
                            ...
                            <div class=\'colunaDinamica_left\'>
                                <div class=\'coluna50_left\'>
                                    ...
                                    <div id=\'msgErroValidade\' class=\'erroInputFinalizarCompraLightbox vermelho coluna100\'>Data inválida.</div>
                                </div>    
                                <div class=\'coluna50_right\'>
                                    <div class=\'tituloInputFinalizarCompraLightbox margin_top\'>CCV</div>
                                    ...
                                    <div id=\'msgErroCCV\' class=\'erroInputFinalizarCompraLightbox vermelho coluna100\'>CCV inválido.</div>
                                </div>
                            </div>
                        ...
                        <div class=\'coluna100\'>
                            ...
                            <div class=\'colunaDinamica_left\'>
                                ...
                                <div id=\'msgErroCpf\' class=\'erroInputFinalizarCompraLightbox vermelho coluna100\'>CPF/CNPJ inválido.</div>
                            </div>
                            ...
                            <div class=\'colunaDinamica_right\'>
                                <div class=\'coluna23\'>
                                    ...
                                    <div id=\'msgErroDDD\' class=\'erroInputFinalizarCompraLightbox vermelho coluna100\'>DDD inválido.</div>
                                </div>
                                <div class=\'coluna75\'>
                                    <div class=\'tituloInputFinalizarCompraLightbox margin_top\'>Celular</div>
                                    ...
                                    <div id=\'msgErroCelular\' class=\'erroInputFinalizarCompraLightbox vermelho coluna100\'>Número inválido.</div>
                                </div>
                            </div>
        ...
        if ('transparent' != $this->method) {
                ...
                if (wp_verify_nonce($_POST['_nonce_payment'], 'payment_user')) {
                    ...
                    if ($resultado['HttpStatusCode'] == 200) {
                        ...
                        foreach ($woocommerce->cart->get_cart() as $cart_item_key => $cart_item) {
                            ...
                            //var_dump($quantity);
                            // Listas de nome e quantidade de produtos
                            $produtos[$count] = "*" . $quantity . "x* " . $product->name . "%0a%0a";
                            // $QuantidadeProdutos[$count] = $quantity;
                            $count++;
                        }
                        ...
                        foreach ($order->get_address()  as $adress => $value) {
                            echo  $value . "<br>";
                        }
                        ...
                        $jsonQuantidadeProdutos = json_encode($QuantidadeProdutos);
                        $endereco = $order->get_address();
                        ...
                        wc_enqueue_js('
                            $(document).ready(function () {
                                ...
                                wcsvl_modalSucesso("' . get_option('home') . esc_url('index.php/loja') . '", "bgModal", nomeModalSucesso, valorModalSucesso, bandeiraCartaoModalSucesso, numeroCartaoModalSucesso, parcelaModalSucesso, codigoModalSucesso , ' . $jsonProdutos . ' , ' . $jsonQuantidadeProdutos . ' , ' . $whatsApp . ' , ' . $jsonEndereco . ');
                            });
                        ');
                    } else {
                        wc_enqueue_js('
            ...
            if (isset($_POST['cancelarSim'])) {
                wc_enqueue_js('
                    ...
                    window.document.location.href = "' . get_option('home') . '"
                ');
            } 
